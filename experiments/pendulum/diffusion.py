...
parser.add_argument('--niters', type=int, default=10000, help='Number of learning iterations.')
...
def loss_fn(model_: NNPendulum_decoder_SSM, key_):
    ...
    def logpdf_y_cond_x_NN_(y, x):
        ...
        return jnp.sum(weighted_log_probs_pixelwise, axis=(1, 2, 3))
